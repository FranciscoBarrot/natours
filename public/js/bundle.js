...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZnJhbmNpc2NvYmFycm90IiwiYSI6ImNrdTFucHo3dzB0eG4ydnFnMXRycjYxcjgifQ.oHcznIodzY5hg-unAwd8Lw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/franciscobarrot/cku1o0d3k1l0q17mv9cnsmzcg',
    scrollZoom: false
    /* center: [-118.11, 34.11],
    zoom: 4, */
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            (0, _alert.showAlert)('error', 'Error loggin out! Try it again');
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dat, type) {
    var url, res, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JjmStGu8SmZgoVOfwt9VI0WshWe3Uycnz1YL8a6vur1HaTil2f4arGMOjOjTxzQWSH3n9SxmOMpikcCxdqoMzBz00KSMxZ9Ih'); // 1) get checkout session from api
